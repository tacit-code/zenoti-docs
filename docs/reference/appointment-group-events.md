...
**Source:** https://docs.zenoti.com/reference/appointment-group-events

---

## Description

This automation notifies your application whenever the following group appointment events occur:
...
Created: When a new appointment group is created.

Status: When the status of an appointment group is changed.

Check the API documentation for appointment group events.
