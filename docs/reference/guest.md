...
**Source:** https://docs.zenoti.com/reference/guest

---

## Description

This automation notifies your application whenever the following guest events occur in Zenoti:
...
Check the API documentation for guest events.
