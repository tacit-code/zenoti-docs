...
**Source:** https://docs.zenoti.com/reference/list-all-employees-of-a-center

**Endpoint:** `/v1/centers/{center_id}/employees`
...
​
3
url = "https://api.zenoti.com/v1/centers/center_id/employees?page=1&size=10"
4
​
5
headers = {
