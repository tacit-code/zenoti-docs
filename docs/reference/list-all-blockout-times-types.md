...
**Source:** https://docs.zenoti.com/reference/list-all-blockout-times-types

**Endpoint:** `/v1/organizations/blockouttimes/types?page=1&size=100&source=0`
...
​
3
url = "https://api.zenoti.com/v1/organizations/blockouttimes/types?page=1&size=100&source=0"
4
​
5
headers = {
