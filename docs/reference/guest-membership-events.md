...
**Source:** https://docs.zenoti.com/reference/guest-membership-events

---

## Description

This automation notifies your application, whenever the following membership events occur:
...
Check the API documentation for guest membership events.
